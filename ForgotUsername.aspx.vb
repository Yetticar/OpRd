...
Public Class ForgotUsername
    ...
    Protected Sub cmdSubmit_Click(sender As Object, e As EventArgs) Handles cmdSubmit.Click
        ...
        Dim cmd As SqlCommand = New SqlCommand(("Select name, username from Teachers where email ='" & txtUsername1.Text & "'"), conn)
        conn.Open()
        ...
        If Reader.HasRows Then
            ...
            smtp.Send("communications@cullmanec.com", email, "Operation Roundup Login Assistance", "Thank you " & name & " your Username is " & username & ". " & vbNewLine & "Log in here - http://operationroundup.azurewebsites.net/Login.aspx")
