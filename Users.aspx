<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Users.aspx.vb" Inherits="jc.Users" %>
    ...
    <body style="margin:0; padding:0; background-color: rgba(142, 169, 186, 0.59);">
          ...
          <!--  <div id="header">
           ...
           <div class="auto-style7">
               ...
               <asp:Label ID="Label1" runat="server" CssClass="auto-style8" Text="Users"></asp:Label>
               <br />
               <asp:GridView ID="GridView1" runat="server" Width="95%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OpRdConnectionString %>" SelectCommand="SELECT [Username], [Password], [Name], [Email], [School], [Type] FROM [teachers] ORDER BY [School]"></asp:SqlDataSource>
